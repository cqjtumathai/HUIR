...
def parse_args():
   ...
   #Model Arguments
    ...
    parser.add_argument('--topk_list', type=list, default=[5, 10, 20, 50], help='List of topk values for evaluation')
    ...
    parser.add_argument('--emb_size', type=int, default=16, help='timestep embedding size')#16
    ...
    parser.add_argument('--noise_min', type=float, default=1e-4, help='noise lower bound for noise generating')
    ...
    # main loss_weight
    parser.add_argument('--SRPCloss', type=float, default=0.05)
    parser.add_argument('--ISECloss', type=float, default=1e-3)
    parser.add_argument('--bprloss', type=float, default=2)
