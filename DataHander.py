...
class DataHandler:
    def __init__(self):
        ...
        if args.dataset == 'ciao':
            ...
            predir = './datasets/douban/dataset.pkl/'
            self.datapath = predir + 'dataset_douban.pkl'
        elif args.dataset == 'flickr':
            predir = './datasets/flickr/dataset.pkl/'
            self.datapath = predir + 'dataset.pkl'
        self.predir = predir
    ...
    def LoadData(self):
        ...
        self.trainloader = DataLoader(dataset=trainset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
        self.valloader = DataLoader(dataset=valset, batch_size=args.test_batch_size, shuffle=False, num_workers=args.num_workers)
        self.testloader = DataLoader(dataset=testset, batch_size=args.test_batch_size, shuffle=False, num_workers=args.num_workers)
